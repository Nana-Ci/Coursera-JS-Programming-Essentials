 ...
 */
let employeeStatus = "Employee";  // You can change this to test other roles
let authorization;
...
switch (employeeStatus) {
  ...
  case "Subscriber":
    ...
    break;
  case "Non-Subscriber":
    authorization = "Please enroll or subscribe to access Dietary Services";
    break;
  default:
    authorization = "Role not recognized. Access denied.";
}
